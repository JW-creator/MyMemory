...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val READ_EXTERNAL_PHOTOS_CODE = 255
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setDisplayHomeAsUpEnabled(true) // show a back button
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask { photoUploadTask ->
                    ...
                    if(!downloadUrlTask.isSuccessful) {
                        ...
                        Toast.makeText(this, "Failed to upload iamge", Toast.LENGTH_SHORT).show()
